...
public class DigitalPreview : MonoBehaviour
{
...
//	{
//		this.transform.parent.gameObject.transform.rotation = GyroToUnity(Input.gyro.attitude);
////		this.transform.parent.gameObject.transform.rotation.eulerAngles = new Vector3(parent.x + 90, parent.y, parent.z);
//
//	}
//
//	private static Quaternion GyroToUnity(Quaternion q)
//	{
////		return new Quaternion(q.x, q.y, -q.z, -q.w);//remove minuses to fix rotation axis
//		return new Quaternion(q.x, q.y, q.z, q.w)* Quaternion.Euler(-90.0f, 0.0f, 0.0f);
//
//	}
}